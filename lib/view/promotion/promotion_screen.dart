...
import 'package:playzone/model/Mlm_Plan_model.dart';
...
import 'package:playzone/view/promotion/horizontal_scale.dart';
import 'package:playzone/view/promotion/horizontal_scale_two.dart';
import 'package:playzone/view/promotion/level_plan.dart';
                              ...
                              children: [
                                ...
                                kIsWeb == true
                                    ? AppBtn(
                                        ...
                                        fontWeight: FontWeight.w900,
                                        onTap: () async {
                                          String referralUrl ='https://web.play-zone.live?id=${userData.referralCode}';
                                          Share.share(
                                              'Its my referral Code : *${userData.referralCode}* link to join: $referralUrl  ,'
                                              ' Download Now :https://play-zone.live/play-zone.apk',
                                              subject: 'Join Now !!');
                                        },
                                      )
                                    : AppBtn(
                                        ...
                                        onTap: () async {
                                          await FlutterShare.share(
                                              ...
                                              linkUrl: "https://web.play-zone.live?id=${userData.referralCode}",
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                              ...
                                              borderRadius:
                                                  BorderRadius.circular(10)),
                                          child: textWidget(
                                            text: double.parse(bonus.toString())
                                                .toStringAsFixed(2),
                                            fontSize: width * 0.045,
                                          ),
                                        ),
