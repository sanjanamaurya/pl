...
import 'package:playzone/view/home/mini/aviator_constant/aviator_assets.dart';
import 'package:playzone/view/home/mini/aviator_model/result_history_model.dart';
import 'package:playzone/view/home/mini/my_bet.dart';
import 'package:playzone/view/home/mini/widget/Marquee/marquee.dart';
import 'package:playzone/view/home/mini/widget/small_toggel_switch.dart';
import 'package:playzone/view/home/mini/widget/switch.dart';
import 'package:playzone/view/home/mini/widget/toggel_switch.dart';
...
class _GameAviatorState extends State<GameAviator>
                    ...
                    children: [
                      ...
                      Text(
                          context
                              .read<Profile>()
                              .wallet==null?'':
                        double.parse(context.read<Profile>().wallet).toStringAsFixed(2),
  ...
  void deductAmount() {
    ...
    if (double.parse(context.read<Profile>().wallet) >= amountToDeduct) {
      setState(() {
        amount.text = (selectedAmount * value).toString();
      });
      double.parse(context.read<Profile>().wallet);
    } else {
  ...
  void connectToServer() {
    _socket = IO.io(
      context.read<Profile>().aviatorLink.toString(),
    ...
    _socket.on(context.read<Profile>().aviatorEventName, (data) {
      if (_isMounted) {
        setState(() {
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        final  price = number[index].price;
                        Color textColor;
                        if (price > 1 && price < 2) {
  ...
  betView(String amount) async {
    ...
    final response = await http
        .get(Uri.parse("${ApiUrl.betPlaced}userid=$userid&amount=$amount"));
        ...
        children: [
          Positioned(
            ...
            child: AlertDialog(
              ...
              content: textWidget(
                text: "Amount: ₹ $totalamount,  Time:$time",
                fontSize: 12,
                color: Colors.white,
                fontWeight: FontWeight.bold,
              ),
