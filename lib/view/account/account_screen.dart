...
import 'package:playzone/view/wallet/wallet_history.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:playzone/main.dart';
import 'package:playzone/res/components/clipboard.dart';
import 'package:playzone/view/auth/customerService.dart';
...
import 'package:playzone/view/account/aboutus.dart';
import 'package:playzone/view/account/change_password.dart';
import 'package:playzone/view/account/logout.dart';
import 'package:playzone/view/account/service_center/contact_us.dart';
import 'package:playzone/view/account/service_center/privacy_policy.dart';
import 'package:playzone/view/account/service_center/terms_condition.dart';
...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    openTelegramTwo() async {
      final String groupLink = contactusData!.telegramTwo.toString(); // Replace with your Telegram group link
